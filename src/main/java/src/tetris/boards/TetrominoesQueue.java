...
import src.tetris.tetrominoes.generators.TetrominoesGenerator;
import src.tetris.tetrominoes.Tetromino;

import java.awt.*;

import static src.tetris.Config.CELL_SIZE;
import static src.tetris.Config.TETROMINOES_QUEUE_WIDTH;
