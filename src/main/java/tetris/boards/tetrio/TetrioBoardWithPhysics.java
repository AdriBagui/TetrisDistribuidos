...
public class TetrioBoardWithPhysics extends BoardWithPhysics {
    ...
    public TetrioBoardWithPhysics(int x, int y, long seed) {
        super(x + TETROMINO_HOLDER_WIDTH, y, BOARD_ROWS, BOARD_SPAWN_ROWS, BOARD_COLUMNS, TETRIO_TETROMINOES_QUEUE_SIZE, TetrominoesGeneratorFactory.BAG_WITH_7, seed, RotationSystemFactory.SUPER_ROTATION_SYSTEM, TETRIO_INITIAL_GRAVITY);
