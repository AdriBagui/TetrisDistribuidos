...
public class NESBoardWithPhysics extends BoardWithPhysics {
    ...
    protected void increaseLevel() {
        ...
        switch (level) {
            case 1:
                increment = 0.002778167;
                break;
            case 2:
                increment = 0.002586569;
                break;
            case 3:
                increment = 0.004414411;
                break;
            case 4:
                increment = 0.004364247;
                break;
            case 5:
                increment = 0.008081939;
                break;
            case 6:
                increment = 0.008890133;
                break;
            case 7:
                increment = 0.019396655;
                break;
            case 8:
                increment = 0.04156426;
                break;
            case 9:
                increment = 0.045720686;
                break;
            case 10:
                increment = 0.0400056;
                break;
