...
public class Config {
    ...
    public static final double SOFT_DROP_FACTOR_GRAVITY_INCREMENT = 0.2;
    public static final int SOFT_DROP_DELAY_QUOTIENT = 2;
    ...
    public static final int NES_LOCK_DELAY_FRAMES = 3;
