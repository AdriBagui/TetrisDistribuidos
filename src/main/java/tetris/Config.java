...
public class Config {
    ...
    public static final int QUEUE_WIDTH = 5*CELL_SIZE;
    public static final int HOLD_WIDTH = 5*CELL_SIZE;
    public static final int HOLD_HEIGHT = 5*CELL_SIZE;
    ...
    public static final int BOARD1_X = FRAME_PADDING + HOLD_WIDTH;
    public static final int BOARD1_Y = FRAME_PADDING;
    public static final int BOARD2_X = FRAME_PADDING + HOLD_WIDTH + BOARD_WIDTH + QUEUE_WIDTH + FRAME_PADDING + HOLD_WIDTH;
    public static final int BOARD2_Y = BOARD1_Y;
    public static final int PANEL_WIDTH = 3*FRAME_PADDING + 2*HOLD_WIDTH + 2*BOARD_WIDTH + 2*QUEUE_WIDTH;
